...
{
    public partial class addCompletedSubject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletedSubjects", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "UnsatisfactoryMarks",
                columns: table => new
                {
                    UnsatisfactoryMarkID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MarkID = table.Column<int>(type: "int", nullable: false),
                    GroupID = table.Column<int>(type: "int", nullable: false),
                    StudentID = table.Column<int>(type: "int", nullable: false),
                    SubjectID = table.Column<int>(type: "int", nullable: false),
                    UnsatisfactoryValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UnsatisfactoryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CorrectedValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CorrectedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnsatisfactoryMarks", x => x.UnsatisfactoryMarkID);
                });
