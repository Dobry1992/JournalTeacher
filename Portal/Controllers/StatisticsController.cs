    ...
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Teachers(string searchString_1, string searchString_2, string searchString_3)
        {
            ...
            foreach (var teacher in teachers)
            {
                ...
                instTeacherRaiting.Raiting = Math.Round(mrks.Sum() / mrks.Count, 2);
            ...
            foreach (var teacher in subTeachers)
            {
                ...
                teachersSubView.SubValue = (Math.Round((subjectMarksDouble.Sum() / subjectMarksDouble.Count), 2)).ToString().Replace(",", ".");
            ...
            foreach (var teacher in depTeachers)
            {
                ...
                teachersDepView.DepValue = (Math.Round((depMarksDouble.Sum() / depMarksDouble.Count), 2)).ToString().Replace(",", ".");
            ...
            foreach (var teacher in groupTeachers)
            {
                ...
                teachersGroupView.GroupValue = (Math.Round((groupMarksDouble.Sum() / groupMarksDouble.Count), 2)).ToString().Replace(",", ".");
